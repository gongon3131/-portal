		...
		<div class="row">
			...
			<main role="main" class="col-md-9 col-lg-12 px-md-4">
				<div class="form-inline">
					<h3 class="section-title">SV・リーダーシフト</h3>
					{html_options class=form-control name=section_list id=section_list options=$section_list_ary selected=$tshs_id}
					<!--<button type="button" class="btn btn-primary ml-3" id="before_confirm_regist">表示</button>-->
