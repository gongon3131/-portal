...
<html>
	<head>
		...
		<script src="{$base_url}js/jquery/popper.min.js"></script>
		<script src="{$base_url}js/jquery/bootstrap.min.js"></script>
		<!--bootstrap-->
		...
		-->
		<!--common css-->
		<link rel="stylesheet" href="{$base_url}css/common.css" type="text/css" media="screen" />
		<!--common js-->
		<script type="text/javascript" src="{$base_url}js/common/common.js?v={$var}"> </script>
