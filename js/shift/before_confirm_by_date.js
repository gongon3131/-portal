		...
		success: function(json_data) {   
            ...
            if(json_data == ""){
                ...
                if(activated_tab !== undefined){
                    tab_name = activated_tab.href.replace("http://192.168.4.233/new_portal/shift/before_confirm_by_date.php#" , "");
                }
...
function paging_form(){
    ...
    Object.keys(shift_data_ary).forEach(function(key) {
        ...
        contant += '<input type="text" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" id="bc_first_hour_sta_' + shift_data_ary[key]['tdbc_user_id'] + '" name="bc_first_hour_sta_' + shift_data_ary[key]['tdbc_user_id'] + '" value="' + first_hour_sta + '" class="form-control w15 form_right shift_form_text" oninput="value = value.replace(/[^0-9]+/i,' + "'');" + '">';
        contant += '：';
        contant += '<select data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" name="bc_first_min_sta_' + shift_data_ary[key]['tdbc_user_id']  + '" class="form-control shift_form_text" id="bc_first_min_sta_' + shift_data_ary[key]['tdbc_user_id']  + '">';
        if(first_min_sta = "00"){
        ...
        contant += '</select>';
        contant += '&nbsp;～&nbsp;';
        contant += '<input type="text" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" id="bc_first_hour_end_' + shift_data_ary[key]['tdbc_user_id'] + '" name="bc_first_hour_end_' + shift_data_ary[key]['tdbc_user_id'] + '" value="' + first_hour_end + '" class="form-control w15 form_right shift_form_text">';
        contant += '：';
        contant += '<select data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] +'" name="bc_first_min_end_' + shift_data_ary[key]['tdbc_user_id'] + '" class="form-control shift_form_text" id="bc_first_min_end_' + shift_data_ary[key]['tdbc_user_id'] + '">';
        if(first_min_end = "00"){
            contant += '<option label="" value="00" selected>00</option>';
            contant += '<option label="" value="30">30</option>';
        ...
        contant += '<div class="form-inline">';
        contant += '<div class="form_center">';
        contant += '<input type="text" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" id="bc_second_hour_sta_' + shift_data_ary[key]['tdbc_user_id'] + '" name="bc_second_hour_sta_' + shift_data_ary[key]['tdbc_user_id'] + '" value="' + second_hour_sta + '" class="form-control w15 form_right shift_form_text">';
        contant += '：';
        contant += '<select data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" name="bc_second_min_sta_' + shift_data_ary[key]['tdbc_user_id'] + '" class="form-control shift_form_text" id="bc_second_min_sta_' + shift_data_ary[key]['tdbc_user_id'] + '">';
        ...
        contant += '</select>';
        contant += '&nbsp;～&nbsp;';
        contant += '<input type="text" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" id="bc_second_hour_end_' + shift_data_ary[key]['tdbc_user_id'] + '" name="bc_second_hour_end_' + shift_data_ary[key]['tdbc_user_id'] + '" value="' + second_hour_end + '" class="form-control w15 form_right shift_form_text">';
        contant += '：';
        contant += '<select data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '# name="bc_second_min_end_' + shift_data_ary[key]['tdbc_user_id'] + '" class="form-control shift_form_text" id="bc_second_min_end_' + shift_data_ary[key]['tdbc_user_id'] + '">';
        ...
        if(shift_data_ary[key]['tdbc_midnight_flg'] == "1"){
            contant += '<td><input type="checkbox" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" name="midnight_' + shift_data_ary[key]['tdbc_user_id'] + '" id="midnight_' + shift_data_ary[key]['tdbc_user_id'] + '" value="1" class="form-control" checked></td>';
        }else{
            contant += '<td><input type="checkbox" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" name="midnight_' + shift_data_ary[key]['tdbc_user_id'] + '" id="midnight_' + shift_data_ary[key]['tdbc_user_id'] + '" value="1" class="form-control"></td>';
        }
        //休日
        if(shift_data_ary[key]['tdbc_holiday_flg'] == "1"){
            contant += '<td><input type="checkbox" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" name="holiday_' + shift_data_ary[key]['tdbc_user_id'] + '" id="holiday_' + shift_data_ary[key]['tdbc_user_id'] + '" value="1" class="form-control" checked></td>';
        }else{
            contant += '<td><input type="checkbox" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" name="holiday_' + shift_data_ary[key]['tdbc_user_id'] + '" id="holiday_' + shift_data_ary[key]['tdbc_user_id'] + '" value="1" class="form-control"></td>';
        }
        //有休
        if(shift_data_ary[key]['tdbc_paid_holiday_flg'] == "1"){
            contant += '<td><input type="checkbox" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" name="paid_holiday_' + shift_data_ary[key]['tdbc_user_id'] + '" id="paid_holiday_' + shift_data_ary[key]['tdbc_user_id'] + '" value="1" class="form-control" checked></td>';
        }else{
            contant += '<td><input type="checkbox" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" name="paid_holiday_' + shift_data_ary[key]['tdbc_user_id'] + '" id="paid_holiday_' + shift_data_ary[key]['tdbc_user_id'] + '" value="1" class="form-control"></td>';
        }
        //メモ
        contant += '<td><input type="text" data-target-userid-fm="' + shift_data_ary[key]['tdbc_user_id'] + '" name="tdbc_memo_' + shift_data_ary[key]['tdbc_user_id'] + '" value="' + shift_data_ary[key]['tdbc_memo'] + '" id="tdbc_memo_' + shift_data_ary[key]['tdbc_user_id'] + '" class="form-control"></td>';
        //公開・非公開フラグ
        contant += '<input type="hidden" id="confirm_flg_' + shift_data_ary[key]['tdbc_user_id'] + '" value="' + shift_data_ary[key]['confirm_flg'] + '">';
        //前日夜勤フラグ
        contant += '<input type="hidden" id="yesterday_midnight_flg_' + shift_data_ary[key]['tdbc_user_id'] + '" value="' + shift_data_ary[key]['yesterday_midnight_flg'] + '">';
        contant += '</tr>';
    })					
...
function paging_graph(){
    ...
    Object.keys(shift_data_ary).forEach(function(key) {
        ...
        contant += '<td id="op-col00_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="0" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col01_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="1" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col02_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="2" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col03_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="3" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col04_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="4" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col05_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="5" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col06_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="6" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col07_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="7" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col08_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="8" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col09_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="9" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col10_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="10" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col11_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="11" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col12_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="12" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col13_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="13" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col14_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="14" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col15_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="15" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col16_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="16" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col17_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="17" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col18_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="18" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col19_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="19" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col20_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="20" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col21_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="21" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col22_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="22" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<td id="op-col23_' + shift_data_ary[key]['tdbc_user_id'] + '" data-min="00" data-hour="23" data-target-userid="' + shift_data_ary[key]['tdbc_user_id'] + '"></td>';
        contant += '<input type="hidden" value="' + shift_data_ary[key]['tdbc_memo'] + '" id="tdbc_memo_gh' + shift_data_ary[key]['tdbc_user_id'] + '" data-target-userid="' + shift_data_ary[key]['tdbc_user_id']  + '">';
        contant += '<input type="hidden" value="' + shift_data_ary[key]['confirm_flg'] + '" id="confirm_flg_' + shift_data_ary[key]['tdbc_user_id'] + '" data-target-userid="' + shift_data_ary[key]['tdbc_user_id']  + '">';
        //前日夜勤フラグ（hiddenに保存）
...
$('a[data-toggle="tab"]').on('show.bs.tab', function (e) {
	...
	var tab_name = activated_tab.href.replace("http://192.168.4.233/new_portal/shift/before_confirm_by_date.php#" , "");
	...
	//グラフ⇒フォームへのタブ遷移
        ...
        console.log("flag:"+chk_section_graph())
        if(chk_section_graph() == false){
            alert("3区間以上の勤務時間が設定されています");
            return false;
        }

		save_before_confirm_for_graph();
		set_form_by_date();
		//30分登録ボタンを非表示に
		$('#graph_min30').css('display','none');
...
$(document).on("click","[id^=bc_first_],[id^=bc_second_],[id^=tdbc_memo_ ]", function() {

    //ダブルクリックされたセルのユーザーを取得
    var target_userid = $(this).data('target-userid-fm'); 

    //公開非公開フラグ
    var confirm_flg = $("#confirm_flg_" + target_userid).val();

    if(confirm_flg == 1){
        alert("すでに確定済みのシフトなので編集できません");
        $(this).trigger('blur');
        //return false;
    }
...
$(document).on("dblclick","[id^=op-col]", function() {
    ...
    //ダブルクリックされたセルのユーザーを取得
    var target_userid = $(this).data('target-userid'); 
	//クラス名取得
...
$(document).on("click","[id^=holiday_]", function() {
    ...
    //公開非公開フラグ
    var confirm_flg = $("#confirm_flg_" + target_opid).val();
...
function chk_over_hour(){
    ...
    Object.keys(shift_data_ary).forEach(function(key) {
        ...
        //第1区間の開始終了時刻      
        var first_hour_sta = String(shift_data_ary[key]['tdbc_start_time_first']).substring(0,2);
        first_hour_sta = Number(first_hour_sta); 
        var first_hour_end = String(shift_data_ary[key]['tdbc_end_time_first']).substring(0,2);
        first_hour_end = Number(first_hour_end); 
        console.log(first_hour_end - first_hour_sta);
        if(first_hour_end - first_hour_sta > 9){
            over_hour_flg = 1;
        }

        //第2区間の開始終了時刻      
        var second_hour_sta = String(shift_data_ary[key]['tdbc_start_time_second']).substring(0,2);
        second_hour_sta = Number(second_hour_sta); 
        var second_hour_end = String(shift_data_ary[key]['tdbc_end_time_second']).substring(0,2);
        second_hour_end = Number(second_hour_end); 

        if(second_hour_end - second_hour_sta > 8){
            over_hour_flg = 1;
        }
...
function chk_confirm(){
    ...
    Object.keys(shift_data_ary).forEach(function(key) {
        ...
        if(shift_data_ary[key]['confirm_flg'] == 1 ){
...
//登録ボタン押下
$(document).on("click","#bofore_confirm_regist", function() {
    ...
    if(chk_over_hour() == false){
        let checkSaveFlg = window.confirm('実働8時間以上の勤務時間がありますが、そのまま登録しますか？');
        if(checkSaveFlg == false){
            return false;
        }
    }
    ...
    if(isEmpty(shift_data_ary)){
        alert("対象日のシフトは全て確定済みとなっています");
        return false;
    }
	...
	$.ajax({
		...
		scriptCharset: 'utf-8',
		data:          {
						'action'	  : 'before_confirm_shift_regist_by_date',
