...
function set_before_confirm_shift_for_graph_by_user(){
    ...
    Object.keys(shift_data_ary).forEach(function(key) {
        ...
        //メモ情報の反映
        $("#tdbc_memo_gh" + current_section_date).val(memo);
        //メモ情報の反映
        if(memo != ""){
            $("#memo_icn_" + current_section_date).attr("src","../img/memo_act.png");
        }else{
            $("#memo_icn_" + current_section_date).attr("src","../img/memo.png");
        }
